...
You can install it like a regular Firefox extension by clicking [here](https://github.com/aloglu/hoverbar/releases/latest/download/hoverbar.xpi). The file is signed by Mozilla and should work in any modern version of Firefox without additional effort.

## License

Released under the [MIT License](https://github.com/aloglu/hoverbar/blob/main/LICENSE).
